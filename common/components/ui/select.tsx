...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-10 flex-row items-center justify-between gap-2 rounded-md border border-input bg-background px-3 py-2 text-foreground shadow-sm shadow-black/5 dark:bg-input/30 dark:active:bg-input/50 sm:h-9',
        Platform.select({
